...
public enum TMDLocalizationKey: String, Sendable {
    ...
    case playbackBase = "report.playbackBase"
    ...
    case minor = "key.minor"
    case modeAmbiguous = "tonality.mode.ambiguous"
    case modeModal = "tonality.mode.modal"
    case modeInsufficient = "tonality.mode.insufficient"
    ...
    case summaryCleanMinor = "tonality.summary.cleanMinor"
    case summaryColorMinor = "tonality.summary.colorMinor"
    case moodCleanMajor = "tonality.mood.cleanMajor"
    case moodContemporaryMajor = "tonality.mood.contemporaryMajor"
    case moodCleanMinor = "tonality.mood.cleanMinor"
    case moodContemporaryMinor = "tonality.mood.contemporaryMinor"
    case moodModal = "tonality.mood.modal"
    case moodInsufficient = "tonality.mood.insufficient"
    ...
    case visualizerInferredTonality = "visualizer.inferredTonality"
    case visualizerConfidence = "visualizer.confidence"
    case visualizerDiatonicEvidence = "visualizer.diatonicEvidence"
    case visualizerAmbiguous = "visualizer.ambiguous"
}
